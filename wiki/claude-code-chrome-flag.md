...
Voir [[claude-opus-47-lovart-brand-design-summary]].

[[claude-opus-47]] pilote Lovart de bout en bout :
...
Voir [[mcp-vs-cli-skills]]. Le `--chrome` MCP est un cas particulier : il ne peut pas être remplacé par une CLI, car l'interface web (Lovart, Figma) n'expose pas d'API CLI. C'est le cas où le MCP est irremplaçable — à condition que le modèle soit capable de l'utiliser efficacement.
